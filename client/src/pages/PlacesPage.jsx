            ...
            {action === 'new' && (
                <div>
                    <form>
                        ...
                        <p className="text-grey-500 text-sm">select all the perks of your place</p>
                        ...
                        <p className="text-grey-500 text-sm">house roules and etc</p>
                        <textarea/>
                        <h2 className="text-2xl mt-4">chek in &check out time ,Max Guests</h2>
                        <p className="text-grey-500 text-sm">add check out and check in times</p>
